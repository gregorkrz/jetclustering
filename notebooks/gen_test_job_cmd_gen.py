...
runs = ["LGATr_training_NoPIDGL_10_16_64_0.8_2025_03_17_20_05_04", "LGATr_training_NoPIDGL_10_16_64_2.0_2025_03_17_20_05_04"]
...
for run in runs:
    for level in ["-pl", "-gl", ""]:
        print("python -m scripts.generate_test_jobs -run {} -step 40000 -template t3 -tag no_pid_eval_test_trainGL {} --custom-test-files \"{}\"  ".format(run, level, " ".join(test_files)))

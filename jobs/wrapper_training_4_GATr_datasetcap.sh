...
srun singularity exec -B /t3home/gkrzmanc/ -B /work/gkrzmanc/ --nv docker://gkrz/lgatr:v3 python -m src.train -train scouting_PFNano_signals2/SVJ_hadronic_std3/s-channel_mMed-900_mDark-20_rinv-0.3_alpha-peak_13TeV-pythia8_n-2000 -val scouting_PFNano_signals2/SVJ_hadronic_std2/s-channel_mMed-900_mDark-20_rinv-0.3 -net src/models/GATr/Gatr.py -bs 64 --gpus 0 --run-name gatr_ds_cap_$1_CONT --val-dataset-size 1000 --train-dataset-size $1 --num-epochs 99999 --attr-loss-weight 0.1 --coord-loss-weight 0.1 --beta-type pt+bc  --gt-radius 1.4 --num-workers 0 --load-model-weights train/gatr_ds_cap_5000_2025_01_29_08_34_51/step_42000_epoch_539.ckpt
...
# bash jobs/wrapper_training_4_GATr_datasetcap.sh 5000
